...
def experiment_scrape(scrape_type = None,name = "", index = 0,export_path=""):
    if scrape_type == "TESS":
        try:
            ...
            #     "download.default_directory": "C:\\Users\\avery\\OneDrive\\Desktop",
        ...
        try:
            ...
            option.add_argument("profile-directory=Profile 1")
        #     prefs = {"download": {
        #     "default_directory": export_path,
        #     "directory_upgrade": True,
        #     "extensions_to_open": ""
        # }}
            option.add_experimental_option("default_directory",export_path)
            option.add_experimental_option("directory_upgrade",True)
            option.add_experimental_option("detach",True)
            driver = webdriver.Chrome(service=service_object,options=option,desired_capabilities=capabilities)
            time.sleep(2)
            driver.get("https://www.amazon.com/alexa-privacy/apd/rvh?")
